...
public class ModdedItemTagGenerator extends ItemTagsProvider {
	...
	public ModdedItemTagGenerator(PackOutput output, CompletableFuture<HolderLookup.Provider> future, CompletableFuture<TagLookup<Block>> provider, Object helper) {
	...
	protected void addTags(HolderLookup.Provider provider) {
		...
		tag(FA_MODIFIER_ETERNAL_INCOMPATIBLE).add(TFItems.GLASS_SWORD.get());

		tag(FD_CABBAGE_ROLL_INGREDIENTS).add(TFItems.RAW_VENISON.get(), TFItems.RAW_MEEF.get());

		tag(RANDOMIUM_BLACKLIST).addTag(ItemTagGenerator.WIP).add(TFItems.GLASS_SWORD.get(),
