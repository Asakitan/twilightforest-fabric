...
public class StonecuttingGenerator {
	...
	protected static void buildRecipes(RecipeOutput output) {
		...
		stonecutting(output, TFBlocks.TWILIGHT_OAK_LOG.get(), TFItems.HOLLOW_TWILIGHT_OAK_LOG_ITEM.get());
		stonecutting(output, TFBlocks.CANOPY_LOG.get(), TFItems.HOLLOW_CANOPY_LOG_ITEM.get());
		stonecutting(output, TFBlocks.MANGROVE_LOG.get(), TFItems.HOLLOW_MANGROVE_LOG_ITEM.get());
		stonecutting(output, TFBlocks.DARK_LOG.get(), TFItems.HOLLOW_DARK_LOG_ITEM.get());
		stonecutting(output, TFBlocks.TIME_LOG.get(), TFItems.HOLLOW_TIME_LOG_ITEM.get());
		stonecutting(output, TFBlocks.TRANSFORMATION_LOG.get(), TFItems.HOLLOW_TRANSFORMATION_LOG_ITEM.get());
		stonecutting(output, TFBlocks.MINING_LOG.get(), TFItems.HOLLOW_MINING_LOG_ITEM.get());
		stonecutting(output, TFBlocks.SORTING_LOG.get(), TFItems.HOLLOW_SORTING_LOG_ITEM.get());

		stonecutting(output, Blocks.OAK_LOG, TFItems.HOLLOW_OAK_LOG_ITEM.get());
		stonecutting(output, Blocks.SPRUCE_LOG, TFItems.HOLLOW_SPRUCE_LOG_ITEM.get());
		stonecutting(output, Blocks.BIRCH_LOG, TFItems.HOLLOW_BIRCH_LOG_ITEM.get());
		stonecutting(output, Blocks.JUNGLE_LOG, TFItems.HOLLOW_JUNGLE_LOG_ITEM.get());
		stonecutting(output, Blocks.ACACIA_LOG, TFItems.HOLLOW_ACACIA_LOG_ITEM.get());
		stonecutting(output, Blocks.DARK_OAK_LOG, TFItems.HOLLOW_DARK_OAK_LOG_ITEM.get());
		stonecutting(output, Blocks.CRIMSON_STEM, TFItems.HOLLOW_CRIMSON_STEM_ITEM.get());
		stonecutting(output, Blocks.WARPED_STEM, TFItems.HOLLOW_WARPED_STEM_ITEM.get());
		stonecutting(output, Blocks.MANGROVE_LOG, TFItems.HOLLOW_VANGROVE_LOG_ITEM.get());
		stonecutting(output, Blocks.CHERRY_LOG, TFItems.HOLLOW_CHERRY_LOG_ITEM.get());
