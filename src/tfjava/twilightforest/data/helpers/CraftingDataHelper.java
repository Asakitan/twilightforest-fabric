...
public abstract class CraftingDataHelper extends RecipeProvider {
	...
	protected final void charmRecipe(RecipeOutput output, String name, TFRegistryObject<? extends Item> result, TFRegistryObject<? extends Item> item) {
	...
	protected final void castleBlock(RecipeOutput output, TFRegistryObject<? extends Block> result, ItemLike... ingredients) {
	...
	protected final void woodenStairsBlock(RecipeOutput output, ResourceLocation loc, TFRegistryObject<? extends Block> result, TFRegistryObject<? extends Block> criteria, ItemLike... ingredients) {
	...
	protected final void stairsBlock(RecipeOutput output, ResourceLocation loc, TFRegistryObject<? extends Block> result, TFRegistryObject<? extends Block> criteria, ItemLike... ingredients) {
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, result.get(), 8)
			.pattern("#  ")
			.pattern("## ")
			.pattern("###")
	...
	protected final void stairsRightBlock(RecipeOutput output, ResourceLocation loc, TFRegistryObject<? extends Block> result, TFRegistryObject<? extends Block> criteria, ItemLike... ingredients) {
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, result.get(), 8)
			.pattern("###")
			.pattern(" ##")
			.pattern("  #")
	...
	protected final void compressedBlock(RecipeOutput output, TFRegistryObject<? extends Block> result, TagKey<Item> ingredient, TFRegistryObject<Item> middleIng) {
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, result.get())
			.pattern("###")
			.pattern("#m#")
			.pattern("###")
			.define('#', ingredient)
			.define('m', middleIng.get())
			.unlockedBy("has_item", has(ingredient))
			.save(output, TwilightForestMod.prefix("compressed_blocks/" + BuiltInRegistries.BLOCK.getKey(result.get()).getPath()));
	}

	protected final void reverseCompressBlock(RecipeOutput output, TFRegistryObject<? extends Item> result, TFRegistryObject<? extends Block> ingredient) {
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, result.get(), 9)
			...
			.save(output, TwilightForestMod.prefix("compressed_blocks/reversed/" + BuiltInRegistries.BLOCK.getKey(ingredient.get()).getPath()));
	}

	protected final void helmetItem(RecipeOutput output, TFRegistryObject<? extends Item> result, TagKey<Item> material) {
	...
	protected final void helmetItem(RecipeOutput output, TFRegistryObject<? extends Item> result, TagKey<Item> material, DataComponentPatch.Builder component) {
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, new ItemStack(result.get(), 1, component.build()))
			...
			.save(output, locEquip(BuiltInRegistries.ITEM.getKey(result.get()).getPath()));
	}

	protected final void chestplateItem(RecipeOutput output, TFRegistryObject<? extends Item> result, TagKey<Item> material) {
	...
	protected final void leggingsItem(RecipeOutput output, TFRegistryObject<? extends Item> result, TagKey<Item> material) {
	...
	protected final void bootsItem(RecipeOutput output, TFRegistryObject<? extends Item> result, TagKey<Item> material) {
	...
	protected final void pickaxeItem(RecipeOutput output, TFRegistryObject<? extends Item> result, TagKey<Item> material, TagKey<Item> handle) {
	...
	protected final void swordItem(RecipeOutput output, TFRegistryObject<? extends Item> result, TagKey<Item> material, TagKey<Item> handle) {
	...
	protected final void axeItem(RecipeOutput output, TFRegistryObject<? extends Item> result, TagKey<Item> material, TagKey<Item> handle) {
	...
	protected final void doorBlock(RecipeOutput output, String name, TFRegistryObject<? extends Block> result, TFRegistryObject<? extends Block> material) {
	...
	protected final void fenceBlock(RecipeOutput output, String name, TFRegistryObject<? extends Block> result, TFRegistryObject<? extends Block> material) {
	...
	protected final void gateBlock(RecipeOutput output, String name, TFRegistryObject<? extends Block> result, TFRegistryObject<? extends Block> material) {
	...
	protected final void planksBlock(RecipeOutput output, String name, TFRegistryObject<? extends Block> result, TagKey<Item> material) {
	...
	protected final void plateBlock(RecipeOutput output, String name, TFRegistryObject<? extends Block> result, TFRegistryObject<? extends Block> material) {
		ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, result.get())
			.pattern("##")
			.define('#', material.get())
			.unlockedBy("has_item", has(material.get()))
	...
	protected final void woodenSlabBlock(RecipeOutput output, String name, TFRegistryObject<? extends Block> result, TFRegistryObject<? extends Block> material) {
	...
	protected final void slabBlock(RecipeOutput output, String name, TFRegistryObject<? extends Block> result, TFRegistryObject<? extends Block> material) {
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, result.get(), 6)
			.pattern("###")
			.define('#', material.get())
			.unlockedBy("has_item", has(material.get()))
	...
	protected final void bannerPattern(RecipeOutput output, String name, TFRegistryObject<? extends Block> trophy, TFRegistryObject<? extends Item> result) {
	...
	protected final void trapdoorBlock(RecipeOutput output, String name, TFRegistryObject<? extends Block> result, TFRegistryObject<? extends Block> material) {
	...
	protected final void woodBlock(RecipeOutput output, String name, TFRegistryObject<? extends Block> result, TFRegistryObject<? extends Block> material) {
	...
	protected final void strippedWoodBlock(RecipeOutput output, String name, TFRegistryObject<? extends Block> result, TFRegistryObject<? extends Block> material) {
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, result.get(), 3)
			.pattern("##")
			.pattern("##")
			.define('#', material.get())
	...
	protected final void signBlock(RecipeOutput output, String name, TFRegistryObject<? extends Item> result, TFRegistryObject<? extends Block> material) {
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, result.get(), 3)
			.pattern("###")
			.pattern("###")
			.pattern(" - ")
	...
	protected final void hangingSignBlock(RecipeOutput output, String name, TFRegistryObject<? extends Item> result, TFRegistryObject<? extends Block> material) {
	...
	protected final void banisterBlock(RecipeOutput output, String name, TFRegistryObject<? extends Block> result, TFRegistryObject<? extends Block> material) {
		this.banisterBlock(output, name, result, material.get());
	}

	protected final void banisterBlock(RecipeOutput output, String name, TFRegistryObject<? extends Block> result, Block material) {
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, result.get(), 3)
			.pattern("---")
			.pattern("| |")
			.define('-', material)
	...
	protected final void dryingRackBlock(RecipeOutput output, String name, TFRegistryObject<? extends Block> result, TFRegistryObject<? extends Block> material) {
		this.dryingRackBlock(output, name, result, material.get());
	}

	protected final void dryingRackBlock(RecipeOutput output, String name, TFRegistryObject<? extends Block> result, Block material) {
	...
	protected final void fieryConversion(RecipeOutput output, TFRegistryObject<? extends Item> result, Item armor, int vials) {
		ShapelessRecipeBuilder.shapeless(RecipeCategory.COMBAT, result.get())
			...
			.group(BuiltInRegistries.ITEM.getKey(result.get()).getPath())
			.save(output, locEquip("fiery_" + BuiltInRegistries.ITEM.getKey(armor).getPath()));
	}

	protected final void buildBoats(RecipeOutput output, TFRegistryObject<? extends Item> boat, TFRegistryObject<? extends Item> chestBoat, TFRegistryObject<? extends Block> planks) {
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.TRANSPORTATION, chestBoat.get())
			.requires(boat.get())
			.requires(ItemTagGenerator.CHESTS_WOODEN)
			.group("chest_boat")
