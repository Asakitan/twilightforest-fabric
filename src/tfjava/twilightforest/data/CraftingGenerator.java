...
//		bannerPattern(output, "questing_ram_banner_pattern", TFBlocks.QUEST_RAM_TROPHY, TFItems.QUEST_RAM_BANNER_PATTERN);
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, TFBlocks.IRON_LADDER.get(), 3)
			...
			.define('-', ItemTagGenerator.NUGGETS_IRON)
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, TFBlocks.CANOPY_WINDOW.get(), 4)
			...
			.pattern("PPP")
			.pattern("GPG")
			.define('G', Ingredient.of(ItemTagGenerator.GLASS_BLOCKS))
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, Blocks.TORCH, 5)
			...
			.define('|', ItemTagGenerator.RODS_WOODEN)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, TFItems.MOSS_SOUP.get())
			...
			.unlockedBy("has_moss", has(TFBlocks.MOSS_PATCH.get()))
			.save(output);

		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, TFItems.BERRY_MEDLEY.get())
			.requires(Items.BOWL)
			.requires(TFItems.RASPBERRY.get())
			.requires(TFItems.BLUEBERRY.get())
			.requires(TFItems.BLACKBERRY.get())
			.requires(TFItems.MALOBERRY.get())
			.unlockedBy("has_raspberry", has(TFItems.RASPBERRY.get()))
			.unlockedBy("has_blueberry", has(TFItems.BLUEBERRY.get()))
			.unlockedBy("has_blackberry", has(TFItems.BLACKBERRY.get()))
			.unlockedBy("has_maloberry", has(TFItems.MALOBERRY.get()))
			.save(output);
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, TFItems.COPPER_NUGGET.get(), 9)
			.requires(Ingredient.of(ItemTagGenerator.INGOTS_COPPER))
			.unlockedBy("has_item", has(ItemTagGenerator.INGOTS_COPPER))
...
//			.save(output);
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, TFItems.ARMOR_SHARD_CLUSTER.get())
			...
			.save(output, TwilightForestMod.prefix("material/" + itemName(TFItems.ARMOR_SHARD_CLUSTER)));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, TFItems.CARMINITE.get())
			...
			.requires(ItemTagGenerator.DUSTS_REDSTONE)
			.requires(Ingredient.of(TFItems.BORER_ESSENCE.get()))
			.requires(ItemTagGenerator.DUSTS_REDSTONE)
			...
			.save(output, TwilightForestMod.prefix("material/" + itemName(TFItems.CARMINITE)));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, TFItems.RAW_IRONWOOD.get(), 2)
			...
			.requires(ItemTagGenerator.NUGGETS_GOLD)
			.unlockedBy("has_item", has(TFItems.LIVEROOT.get()))
			.save(output, TwilightForestMod.prefix("material/" + itemName(TFItems.RAW_IRONWOOD)));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TFItems.MYSTIC_CROWN.get(), 1)
			.pattern("ttt")
			.pattern("t t")
			.pattern("ttt")
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, Items.LEAD, 2)
			.define('~', Items.STRING)
			.define('O', TFItems.MAZE_SLIME_BALL.get())
			.pattern("~~ ")
			.pattern("~O ")
			.pattern("  ~")
			.unlockedBy("has_slime_ball", has(TFItems.MAZE_SLIME_BALL.get()))
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.BREWING, Items.MAGMA_CREAM)
			...
			.requires(TFItems.MAZE_SLIME_BALL.get())
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, Blocks.STICKY_PISTON)
			...
			.define('S', TFItems.MAZE_SLIME_BALL.get())
			.pattern("S")
			.pattern("P")
			.unlockedBy("has_slime_ball", has(TFItems.MAZE_SLIME_BALL.get()))
	...
	private void darkTowerRecipes(RecipeOutput output) {
		ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, TFBlocks.ENCASED_FIRE_JET.get())
			...
			.pattern("∴^∴")
			.pattern("uuu")
			.define('∴', ItemTagGenerator.DUSTS_REDSTONE)
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, TFBlocks.CARMINITE_REACTOR.get())
			...
			.define('6', ItemTagGenerator.CARMINITE_GEMS)
			.define('#', Ingredient.of(TFBlocks.ENCASED_TOWERWOOD.get()))
			.define('%', ItemTagGenerator.ORES_REDSTONE)
			.unlockedBy("has_item", has(ItemTagGenerator.CARMINITE_GEMS))
			.save(output);
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, TFBlocks.MOSSY_TOWERWOOD.get())
			...
			.save(output, TwilightForestMod.prefix("wood/" + blockName(TFBlocks.MOSSY_TOWERWOOD)));
	...
	private void equipmentRecipes(HolderLookup.Provider provider, RecipeOutput output) {
		...
		swordItem(output, TFItems.IRONWOOD_SWORD, ItemTagGenerator.IRONWOOD_INGOTS, ItemTagGenerator.RODS_WOODEN, this.buildEnchants(provider, Pair.of(Enchantments.KNOCKBACK, 1)));
		pickaxeItem(output, TFItems.IRONWOOD_PICKAXE, ItemTagGenerator.IRONWOOD_INGOTS, ItemTagGenerator.RODS_WOODEN, this.buildEnchants(provider, Pair.of(Enchantments.EFFICIENCY, 1)));
		axeItem(output, TFItems.IRONWOOD_AXE, ItemTagGenerator.IRONWOOD_INGOTS, ItemTagGenerator.RODS_WOODEN, this.buildEnchants(provider, Pair.of(Enchantments.FORTUNE, 1)));
		shovelItem(output, TFItems.IRONWOOD_SHOVEL, ItemTagGenerator.IRONWOOD_INGOTS, ItemTagGenerator.RODS_WOODEN, this.buildEnchants(provider, Pair.of(Enchantments.UNBREAKING, 1)));
		hoeItem(output, TFItems.IRONWOOD_HOE, ItemTagGenerator.IRONWOOD_INGOTS, ItemTagGenerator.RODS_WOODEN, this.buildEnchants(provider, Pair.of(Enchantments.EFFICIENCY, 1)));
		...
		swordItem(output, TFItems.STEELEAF_SWORD, ItemTagGenerator.STEELEAF_INGOTS, ItemTagGenerator.RODS_WOODEN, this.buildEnchants(provider, Pair.of(Enchantments.LOOTING, 2)));
		pickaxeItem(output, TFItems.STEELEAF_PICKAXE, ItemTagGenerator.STEELEAF_INGOTS, ItemTagGenerator.RODS_WOODEN, this.buildEnchants(provider, Pair.of(Enchantments.FORTUNE, 2)));
		axeItem(output, TFItems.STEELEAF_AXE, ItemTagGenerator.STEELEAF_INGOTS, ItemTagGenerator.RODS_WOODEN, this.buildEnchants(provider, Pair.of(Enchantments.EFFICIENCY, 2)));
		shovelItem(output, TFItems.STEELEAF_SHOVEL, ItemTagGenerator.STEELEAF_INGOTS, ItemTagGenerator.RODS_WOODEN, this.buildEnchants(provider, Pair.of(Enchantments.EFFICIENCY, 2)));
		hoeItem(output, TFItems.STEELEAF_HOE, ItemTagGenerator.STEELEAF_INGOTS, ItemTagGenerator.RODS_WOODEN, this.buildEnchants(provider, Pair.of(Enchantments.FORTUNE, 2)));
		...
		pickaxeItem(output, TFItems.KNIGHTMETAL_PICKAXE, ItemTagGenerator.KNIGHTMETAL_INGOTS, ItemTagGenerator.RODS_WOODEN);
		swordItem(output, TFItems.KNIGHTMETAL_SWORD, ItemTagGenerator.KNIGHTMETAL_INGOTS, ItemTagGenerator.RODS_WOODEN);
		axeItem(output, TFItems.KNIGHTMETAL_AXE, ItemTagGenerator.KNIGHTMETAL_INGOTS, ItemTagGenerator.RODS_WOODEN);

		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TFItems.FIERY_BOOTS.get())
			.pattern("# #")
			.pattern("# #")
			.define('#', ItemTagGenerator.FIERY_INGOTS)
			.unlockedBy("has_item", has(ItemTagGenerator.FIERY_INGOTS))
			.group("fiery_boots")
			.save(output, locEquip(itemName(TFItems.FIERY_BOOTS)));

		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TFItems.FIERY_LEGGINGS.get())
			.pattern("###")
			.pattern("# #")
			.pattern("# #")
			.define('#', ItemTagGenerator.FIERY_INGOTS)
			...
			.save(output, locEquip(itemName(TFItems.FIERY_LEGGINGS)));

		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TFItems.FIERY_CHESTPLATE.get())
			.pattern("# #")
			.pattern("###")
			.pattern("###")
			.define('#', ItemTagGenerator.FIERY_INGOTS)
			...
			.save(output, locEquip(itemName(TFItems.FIERY_CHESTPLATE)));

		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TFItems.FIERY_HELMET.get())
			.pattern("###")
			.pattern("# #")
			.define('#', ItemTagGenerator.FIERY_INGOTS)
			.unlockedBy("has_item", has(ItemTagGenerator.FIERY_INGOTS))
			.group("fiery_helmet")
			.save(output, locEquip(itemName(TFItems.FIERY_HELMET)));

		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, TFItems.FIERY_PICKAXE.get())
			.pattern("###")
			.pattern(" X ")
			.pattern(" X ")
			.define('#', ItemTagGenerator.FIERY_INGOTS)
			.define('X', ItemTagGenerator.RODS_BLAZE)
			.unlockedBy("has_item", has(ItemTagGenerator.FIERY_INGOTS))
			.group("fiery_pickaxe")
			.save(output, locEquip(itemName(TFItems.FIERY_PICKAXE)));

		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TFItems.FIERY_SWORD.get())
			.pattern("#")
			.pattern("#")
			.pattern("X")
			.define('#', ItemTagGenerator.FIERY_INGOTS)
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, new ItemStack(TFItems.YETI_BOOTS.get(), 1, this.buildEnchants(provider, Pair.of(Enchantments.PROTECTION, 2), Pair.of(Enchantments.FEATHER_FALLING, 4)).build()))
			...
			.define('#', TFItems.ALPHA_YETI_FUR.get())
			.unlockedBy("has_item", has(TFItems.ALPHA_YETI_FUR.get()))
			.save(output, locEquip(itemName(TFItems.YETI_BOOTS)));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, TFItems.GIANT_PICKAXE.get())
			...
			.save(output, locEquip(itemName(TFItems.GIANT_PICKAXE)));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, TFItems.GIANT_SWORD.get())
			...
			.define('X', TFBlocks.GIANT_LOG.get())
			.unlockedBy("has_item", has(TFBlocks.GIANT_COBBLESTONE.get()))
			.save(output, locEquip(itemName(TFItems.GIANT_SWORD)));
		...
		NoSmithingTemplateRecipeBuilder
			...
			.unlocks("has_cloth", has(TFItems.EMPERORS_CLOTH.get()))
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, Blocks.COBBLESTONE, 64)
			...
			.unlockedBy("has_item", has(TFBlocks.GIANT_COBBLESTONE.get()))
			.save(output, TwilightForestMod.prefix(blockName(TFBlocks.GIANT_COBBLESTONE) + "_to_" + BuiltInRegistries.ITEM.getKey(Items.COBBLESTONE).getPath()));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, Blocks.OAK_LOG, 64)
			...
			.save(output, TwilightForestMod.prefix(blockName(TFBlocks.GIANT_LOG) + "_to_" + BuiltInRegistries.ITEM.getKey(Items.OAK_LOG).getPath()));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, Blocks.OAK_LEAVES, 64)
			...
			.save(output, TwilightForestMod.prefix(blockName(TFBlocks.GIANT_LEAVES) + "_to_" + BuiltInRegistries.ITEM.getKey(Items.OAK_LEAVES).getPath()));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, Blocks.OBSIDIAN, 64)
			...
			.save(output, TwilightForestMod.prefix(blockName(TFBlocks.GIANT_OBSIDIAN) + "_to_" + BuiltInRegistries.ITEM.getKey(Items.OBSIDIAN).getPath()));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.COMBAT, TFItems.BLOCK_AND_CHAIN.get())
			...
			.save(output, locEquip(itemName(TFItems.BLOCK_AND_CHAIN)));

		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, TFItems.TANNIN.get())
			.requires(potionIngredient(Potions.WATER))
			.requires(TFBlocks.TWILIGHT_OAK_SAPLING.get())
			.requires(TFBlocks.ROOT_STRAND.get())
			.requires(TFBlocks.TWILIGHT_OAK_LEAVES.get())
			.unlockedBy("has_block", has(TFBlocks.TWILIGHT_OAK_SAPLING.get()))
			.unlockedBy("has_block", has(TFBlocks.ROOT_STRAND.get()))
			.unlockedBy("has_block", has(TFBlocks.TWILIGHT_OAK_LEAVES.get()))
			.save(output);

		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, TFItems.TREATED_LEATHER.get())
			.requires(TFItems.TANNIN.get())
			.requires(ItemTagGenerator.LEATHERS)
			.unlockedBy("has_tannin", has(TFItems.TANNIN.get()))
			.save(output);
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, TFItems.KNIGHTMETAL_RING.get())
			...
			.save(output, locEquip(itemName(TFItems.KNIGHTMETAL_RING)));
		...
		ScepterRecipeBuilder.repairFor(TFItems.ZOMBIE_SCEPTER.get(), 9)
			...
			.save(output, locEquip(itemName(TFItems.ZOMBIE_SCEPTER)));

		Predicate<Ingredient> splitTravellersModifiersRecipes = ingredient -> Arrays.stream(ingredient.getItems()).allMatch(stack -> stack.has(TFDataComponents.IS_TRAVELLERS_GEAR) && !stack.is(TFItems.TRAVELLERS_BELT.get()));

		TravellersGearComponentModifierBuilder.buildShaped(CartesianShapedRecipeBuilder.create(splitTravellersModifiersRecipes)
				.pattern(" R ")
				.pattern("RGR")
				.define('R', TFBlocks.RED_THREAD.get())
				.define('G', TFItems.TRAVELLERS_GOGGLES.get())
				.build(),
		...
		TravellersGearComponentModifierBuilder.buildShaped(CartesianShapedRecipeBuilder.create(splitTravellersModifiersRecipes)
				...
				.define('V', TFItems.TRAVELLERS_VEST.get())
		...
		TravellersGearComponentModifierBuilder.buildShapeless(CartesianShapelessRecipeBuilder.create(splitTravellersModifiersRecipes)
				...
				.ingredient(TFItems.TRAVELLERS_VEST.get())
				.build(),
		...
		TravellersGearComponentModifierBuilder.buildShapeless(CartesianShapelessRecipeBuilder.create(splitTravellersModifiersRecipes)
				.ingredient(TFItems.EXANIMATE_ESSENCE.get())
				.ingredient(TFItems.ORE_MAGNET.get())
				.ingredient(TFItems.LIVEROOT.get())
		...
		TravellersGearComponentModifierBuilder.buildShapeless(CartesianShapelessRecipeBuilder.create(splitTravellersModifiersRecipes)
				.ingredient(TFItems.HYDRA_CHOP.get())
				.ingredient(TFItems.HYDRA_CHOP.get())
				.ingredient(TFItems.HYDRA_CHOP.get())
		...
		TravellersGearComponentModifierBuilder.buildShapeless(CartesianShapelessRecipeBuilder.create(splitTravellersModifiersRecipes)
				.ingredient(TFItems.TRAVELLERS_WINGS.get())
				.ingredient(TFItems.TRAVELLERS_BELT.get())
				.build(),
		...
		TravellersGearComponentModifierBuilder.buildShaped(CartesianShapedRecipeBuilder.create(splitTravellersModifiersRecipes)
				...
				.define('W', TFItems.TRAVELLERS_WINGS.get())
				.define('E', TFItems.BORER_ESSENCE.get())
				.build(),
		...
		TravellersGearComponentModifierBuilder.buildShaped(CartesianShapedRecipeBuilder.create(splitTravellersModifiersRecipes)
				...
				.define('S', ItemTagGenerator.STRINGS)
				.define('W', TFItems.TRAVELLERS_WINGS.get())
		...
		TravellersGearComponentModifierBuilder.buildShaped(CartesianShapedRecipeBuilder.create(splitTravellersModifiersRecipes)
				...
				.define('W', TFItems.TRAVELLERS_WINGS.get())
				.define('F', TFItems.RAVEN_FEATHER.get())
				.build(),
		...
		TravellersGearComponentModifierBuilder.buildShaped(CartesianShapedRecipeBuilder.create(splitTravellersModifiersRecipes)
				...
				.pattern("SBS")
				.define('S', ItemTagGenerator.STRINGS)
				.define('B', ItemTagGenerator.BONES)
				.define('P', Items.PISTON)
				.define('W', TFItems.TRAVELLERS_WINGS.get())
				.build(),
		...
		TravellersGearComponentModifierBuilder.buildShaped(CartesianShapedRecipeBuilder.create(splitTravellersModifiersRecipes)
				.pattern("SBS")
				.pattern("L L")
				.define('B', TFItems.TRAVELLERS_BOOTS.get())
				.define('S', TFItems.MAZE_SLIME_BALL.get())
		...
		TravellersGearComponentModifierBuilder.buildShaped(CartesianShapedRecipeBuilder.create(splitTravellersModifiersRecipes)
				...
				.define('n', ItemTagGenerator.NUGGETS_IRON)
				.define('i', ItemTagGenerator.INGOTS_IRON)
				.build(),
		...
		TravellersGearComponentModifierBuilder.buildShaped(CartesianShapedRecipeBuilder.create(splitTravellersModifiersRecipes)
				.pattern("WBW")
				.pattern("S S")
				.define('W', ItemTagGenerator.STRINGS)
				.define('B', TFItems.TRAVELLERS_BOOTS.get())
		...
		TravellersGearComponentModifierBuilder.buildShaped(CartesianShapedRecipeBuilder.create(splitTravellersModifiersRecipes)
				...
				.define('M', TFBlocks.MOSS_PATCH.get())
				.define('T', Ingredient.of(TFItems.TRAVELLERS_GOGGLES.get(), TFItems.TRAVELLERS_VEST.get(), TFItems.TRAVELLERS_WINGS.get(), TFItems.TRAVELLERS_BOOTS.get()))
				.build(),
		...
		TravellersGearComponentModifierBuilder.buildShaped(CartesianShapedRecipeBuilder.create(splitTravellersModifiersRecipes)
				...
				.define('s', ItemTagGenerator.RODS_WOODEN)
				.define('g', TFItems.TRAVELLERS_GOGGLES.get())
				.build(),
		...
		TravellersGearComponentModifierBuilder.buildShaped(CartesianShapedRecipeBuilder.create(splitTravellersModifiersRecipes)
				...
				.define('s', ItemTagGenerator.SLIME_BALLS)
				.define('g', TFItems.TRAVELLERS_GOGGLES.get())
				.build(),
		...
		DryingRecipeBuilder.drying(Items.ROTTEN_FLESH, TFItems.MONSTER_JERKY.get())
			.unlockedBy("has_meat", has(Items.ROTTEN_FLESH))
			.save(output);

		DryingRecipeBuilder.drying(Items.BEEF, TFItems.BEEF_JERKY.get())
			.unlockedBy("has_meat", has(Items.BEEF))
			.save(output);

		DryingRecipeBuilder.drying(Items.CHICKEN, TFItems.CHICKEN_JERKY.get())
			.unlockedBy("has_meat", has(Items.CHICKEN))
			.save(output);

		DryingRecipeBuilder.drying(Items.PORKCHOP, TFItems.PORK_JERKY.get())
			.unlockedBy("has_meat", has(Items.PORKCHOP))
			.save(output);

		DryingRecipeBuilder.drying(Items.MUTTON, TFItems.MUTTON_JERKY.get())
			.unlockedBy("has_meat", has(Items.MUTTON))
			.save(output);

		DryingRecipeBuilder.drying(Items.RABBIT, TFItems.RABBIT_JERKY.get())
			.unlockedBy("has_meat", has(Items.RABBIT))
			.save(output);

		DryingRecipeBuilder.drying(Items.COD, TFItems.COD_JERKY.get())
			.unlockedBy("has_meat", has(Items.COD))
			.save(output);

		DryingRecipeBuilder.drying(Items.SALMON, TFItems.SALMON_JERKY.get())
			.unlockedBy("has_meat", has(Items.SALMON))
			.save(output);

		DryingRecipeBuilder.drying(Items.TROPICAL_FISH, TFItems.TROPICAL_FISH_JERKY.get())
			.unlockedBy("has_meat", has(Items.TROPICAL_FISH))
			.save(output);

		DryingRecipeBuilder.drying(Items.PUFFERFISH, TFItems.FUGU_JERKY.get())
			.unlockedBy("has_meat", has(Items.PUFFERFISH))
			.save(output);

		DryingRecipeBuilder.drying(TFItems.RAW_VENISON.get(), TFItems.VENISON_JERKY.get())
			.unlockedBy("has_meat", has(TFItems.RAW_VENISON.get()))
			.save(output);

		DryingRecipeBuilder.drying(TFItems.RAW_MEEF.get(), TFItems.MEEF_JERKY.get())
			.unlockedBy("has_meat", has(TFItems.RAW_MEEF.get()))
			.save(output);

		DryingRecipeBuilder.drying(Items.SLIME_BALL, TFItems.GELATINOUS_SLIME_DROP.get())
			.unlockedBy("has_slime_ball", has(Items.SLIME_BALL))
			.save(output);

		DryingRecipeBuilder.drying(TFItems.MAZE_SLIME_BALL.get(), TFItems.GELATINOUS_MAZE_SLIME_DROP.get())
			.unlockedBy("has_maze_slime_ball", has(TFItems.MAZE_SLIME_BALL.get()))
			.save(output);

		DryingRecipeBuilder.drying(TFItems.TREATED_LEATHER.get(), TFItems.TANNED_LEATHER.get())
			.unlockedBy("has_treated", has(TFItems.TREATED_LEATHER.get()))
			.save(output);

		DryingRackCoralRecipes(output);

		DryingRecipeBuilder.drying(Items.BREAD, TFItems.STALE_BREAD.get()).save(output);
	}
	...
	private void blockCompressionRecipes(RecipeOutput output) {
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, TFBlocks.MAZE_SLIME_BLOCK.get())
			.pattern("###")
			.pattern("###")
			.pattern("###")
			.define('#', TFItems.MAZE_SLIME_BALL.get())
			.unlockedBy("has_item", has(TFItems.MAZE_SLIME_BALL.get()))
	...
	private void emptyMapRecipes(RecipeOutput output) {
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, TFItems.MAGIC_MAP_FOCUS.get())
			...
			.requires(ItemTagGenerator.DUSTS_GLOWSTONE)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, TFItems.ORE_MAP.get())
			...
			.requires(ItemTagGenerator.STORAGE_BLOCKS_DIAMOND)
			.requires(ItemTagGenerator.STORAGE_BLOCKS_GOLD)
			.requires(ItemTagGenerator.STORAGE_BLOCKS_IRON)
	...
	private void woodRecipes(RecipeOutput output) {
		...
		doorBlock(output, "transformation", TFBlocks.TRANSFORMATION_DOOR_BLOCK, TFBlocks.TRANSFORMATION_PLANKS);
		...
		gateBlock(output, "canopy", TFBlocks.CANOPY_FENCE_GATE, TFBlocks.CANOPY_PLANKS);
		gateBlock(output, "dark", TFBlocks.DARK_FENCE_GATE, TFBlocks.DARK_PLANKS);
		gateBlock(output, "mangrove", TFBlocks.MANGROVE_FENCE_GATE, TFBlocks.MANGROVE_PLANKS);
		gateBlock(output, "mining", TFBlocks.MINING_FENCE_GATE, TFBlocks.MINING_PLANKS);
		gateBlock(output, "sorting", TFBlocks.SORTING_FENCE_GATE, TFBlocks.SORTING_PLANKS);
		gateBlock(output, "time", TFBlocks.TIME_FENCE_GATE, TFBlocks.TIME_PLANKS);
		gateBlock(output, "transformation", TFBlocks.TRANSFORMATION_FENCE_GATE, TFBlocks.TRANSFORMATION_PLANKS);
		gateBlock(output, "twilight_oak", TFBlocks.TWILIGHT_OAK_FENCE_GATE, TFBlocks.TWILIGHT_OAK_PLANKS);
		...
		plateBlock(output, "canopy", TFBlocks.CANOPY_PRESSURE_PLATE, TFBlocks.CANOPY_PLANKS);
		plateBlock(output, "dark", TFBlocks.DARK_PRESSURE_PLATE, TFBlocks.DARK_PLANKS);
		plateBlock(output, "mangrove", TFBlocks.MANGROVE_PRESSURE_PLATE, TFBlocks.MANGROVE_PLANKS);
		plateBlock(output, "mining", TFBlocks.MINING_PRESSURE_PLATE, TFBlocks.MINING_PLANKS);
		plateBlock(output, "sorting", TFBlocks.SORTING_PRESSURE_PLATE, TFBlocks.SORTING_PLANKS);
		plateBlock(output, "time", TFBlocks.TIME_PRESSURE_PLATE, TFBlocks.TIME_PLANKS);
		plateBlock(output, "transformation", TFBlocks.TRANSFORMATION_PRESSURE_PLATE, TFBlocks.TRANSFORMATION_PLANKS);
		plateBlock(output, "twilight_oak", TFBlocks.TWILIGHT_OAK_PRESSURE_PLATE, TFBlocks.TWILIGHT_OAK_PLANKS);
	...
	private void nagastoneRecipes(RecipeOutput output) {
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, TFBlocks.SPIRAL_BRICKS.get(), 8)
			...
			.pattern("BSS")
			.pattern("BBB")
			.define('B', Ingredient.of(Blocks.STONE_BRICKS, Blocks.MOSSY_STONE_BRICKS, Blocks.CRACKED_STONE_BRICKS, Blocks.CHISELED_STONE_BRICKS))//Ingredient.merge(ImmutableList.of(Ingredient.fromTag(ItemTagGenerator.STONE), Ingredient.fromItems(Blocks.STONE_BRICKS, Blocks.MOSSY_STONE_BRICKS, Blocks.CRACKED_STONE_BRICKS, Blocks.CHISELED_STONE_BRICKS))))
	...
	private void fieryConversions(RecipeOutput output) {
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, TFItems.FIERY_INGOT.get())
			...
			.requires(Ingredient.of(ItemTagGenerator.INGOTS_IRON))
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.COMBAT, TFItems.FIERY_SWORD.get())
			...
			.requires(Ingredient.of(ItemTagGenerator.RODS_BLAZE))
			.unlockedBy("has_item", has(ItemTagGenerator.FIERY_VIAL))
			.group("fiery_sword")
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.TOOLS, TFItems.FIERY_PICKAXE.get())
			...
			.requires(Ingredient.of(ItemTagGenerator.RODS_BLAZE), 2)
			.unlockedBy("has_item", has(ItemTagGenerator.FIERY_VIAL))
			.group("fiery_pickaxe")
	...
	private <T extends AbstractCookingRecipe> void oreberryRecipes(RecipeOutput output, String processName, RecipeSerializer<T> process, AbstractCookingRecipe.Factory<T> factory, int smeltingTime) {
		...
		SimpleCookingRecipeBuilder.generic(Ingredient.of(TFItems.COPPER_BERRY.get()), RecipeCategory.MISC, TFItems.COPPER_NUGGET.get(), 1.0F, smeltingTime, process, factory).unlockedBy("has_item", has(TFItems.COPPER_BERRY.get())).group("copper_nugget").save(output, TwilightForestMod.prefix("material/" + processName + "_copper_nugget").toString());
	...
	private void travellersGearRecipes(RecipeOutput output) {
		ShapedRecipeBuilder.shaped(RecipeCategory.TRANSPORTATION, TFItems.TRAVELLERS_GOGGLES.get())
			.pattern("l l")
			.pattern("plp")
			.pattern("g g")
			.define('l', TFItems.TANNED_LEATHER.get())
			.define('p', ItemTagGenerator.GLASS_PANES_COLORLESS)
			.define('g', ItemTagGenerator.INGOTS_GOLD)
			.unlockedBy("has_leather", has(TFItems.TANNED_LEATHER.get()))
			.save(output, locEquip(itemName(TFItems.TRAVELLERS_GOGGLES)));

		ShapedRecipeBuilder.shaped(RecipeCategory.TRANSPORTATION, TFItems.TRAVELLERS_VEST.get())
			.pattern("l l")
			.pattern("lwl")
			.pattern("lwl")
			.define('l', TFItems.TANNED_LEATHER.get())
			...
			.unlockedBy("has_leather", has(TFItems.TANNED_LEATHER.get()))
			.save(output, locEquip(itemName(TFItems.TRAVELLERS_VEST)));

		ShapedRecipeBuilder.shaped(RecipeCategory.TRANSPORTATION, TFItems.TRAVELLERS_WINGS.get())
			.pattern("g g")
			.pattern("ili")
			.pattern("ici")
			.define('l', TFItems.TANNED_LEATHER.get())
			.define('g', ItemTagGenerator.INGOTS_GOLD)
			.define('i', ItemTagGenerator.INGOTS_COPPER)
			.define('c', ItemTagGenerator.CARMINITE_GEMS)
			.unlockedBy("has_leather", has(TFItems.TANNED_LEATHER.get()))
			.save(output, locEquip(itemName(TFItems.TRAVELLERS_WINGS)));

		ShapedRecipeBuilder.shaped(RecipeCategory.TRANSPORTATION, TFItems.TRAVELLERS_BOOTS.get())
			.pattern("s s")
			.pattern("l l")
			.pattern("l l")
			.define('l', TFItems.TANNED_LEATHER.get())
			.define('s', ItemTagGenerator.STRINGS)
			.unlockedBy("has_leather", has(TFItems.TANNED_LEATHER.get()))
			.save(output, locEquip(itemName(TFItems.TRAVELLERS_BOOTS)));

		ShapedRecipeBuilder.shaped(RecipeCategory.TRANSPORTATION, TFItems.TRAVELLERS_BELT.get())
			.pattern("lll")
			.pattern("ixi")
			.pattern("lll")
			.define('l', TFItems.TANNED_LEATHER.get())
			.define('x', DefaultCustomIngredients.difference(Ingredient.of(ItemTagGenerator.CHESTS_WOODEN), Ingredient.of(ItemTagGenerator.CHESTS_TRAPPED)))
			.define('i', ItemTagGenerator.NUGGETS_IRON)
			.unlockedBy("has_leather", has(TFItems.TANNED_LEATHER.get()))
			.save(output, locEquip(itemName(TFItems.TRAVELLERS_BELT)));

		ShapedRecipeBuilder.shaped(RecipeCategory.TRANSPORTATION, TFItems.TRAVELLERS_GLOVES.get())
			.pattern("s s")
			.pattern("l l")
			.define('l', TFItems.TANNED_LEATHER.get())
			.define('s', ItemTagGenerator.STRINGS)
			.unlockedBy("has_leather", has(TFItems.TANNED_LEATHER.get()))
			.save(output, locEquip(itemName(TFItems.TRAVELLERS_GLOVES)));
	}
	...
	private static @NotNull Ingredient potionIngredient(@NotNull Holder<Potion> potion) {
		return DefaultCustomIngredients.components(Ingredient.of(Items.POTION), DataComponentPatch.builder().set(DataComponents.POTION_CONTENTS, new PotionContents(potion)).build());
	}

	private static String itemName(TFRegistryObject<? extends Item> item) {
		return BuiltInRegistries.ITEM.getKey(item.get()).getPath();
	}

	private static String blockName(TFRegistryObject<? extends Block> block) {
