...
public class BlockLootTables extends BlockLootSubProvider {
	...
	protected void generate() {
		...
		add(TFBlocks.WITHER_SKELETON_SKULL_CANDLE.get(), createSingleItemTable(Blocks.WITHER_SKELETON_SKULL));
		add(TFBlocks.WITHER_SKELETON_WALL_SKULL_CANDLE.get(), createSingleItemTable(Blocks.WITHER_SKELETON_SKULL));
		...
		add(TFBlocks.SKULL_CHEST.get(), skullChest(TFBlocks.SKULL_CHEST.get()));
		...
		dropSelf(TFBlocks.TWILIGHT_OAK_FENCE_GATE.get());
		dropSelf(TFBlocks.TWILIGHT_OAK_PRESSURE_PLATE.get());
		...
		dropSelf(TFBlocks.CANOPY_FENCE_GATE.get());
		dropSelf(TFBlocks.CANOPY_PRESSURE_PLATE.get());
		...
		dropSelf(TFBlocks.MANGROVE_FENCE_GATE.get());
		dropSelf(TFBlocks.MANGROVE_PRESSURE_PLATE.get());
		...
		dropSelf(TFBlocks.DARK_FENCE_GATE.get());
		dropSelf(TFBlocks.DARK_PRESSURE_PLATE.get());
		...
		dropSelf(TFBlocks.TIME_FENCE_GATE.get());
		dropSelf(TFBlocks.TIME_PRESSURE_PLATE.get());
		...
		dropSelf(TFBlocks.TRANSFORMATION_FENCE_GATE.get());
		dropSelf(TFBlocks.TRANSFORMATION_PRESSURE_PLATE.get());
		add(TFBlocks.TRANSFORMATION_DOOR_BLOCK.get(), createSinglePropConditionTable(TFBlocks.TRANSFORMATION_DOOR_BLOCK.get(), DoorBlock.HALF, DoubleBlockHalf.LOWER));
		...
		dropSelf(TFBlocks.MINING_FENCE_GATE.get());
		dropSelf(TFBlocks.MINING_PRESSURE_PLATE.get());
		...
		dropSelf(TFBlocks.SORTING_FENCE_GATE.get());
		dropSelf(TFBlocks.SORTING_PRESSURE_PLATE.get());
