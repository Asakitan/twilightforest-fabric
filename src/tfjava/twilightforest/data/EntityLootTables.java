	...
	public void generate() {
		...
		add(TFEntities.MAZE_SLIME.get(),
			LootTable.lootTable()
				.withPool(LootPool.lootPool()
					.setRolls(ConstantValue.exactly(1))
					.add(LootItem.lootTableItem(TFItems.MAZE_SLIME_BALL.get())
						.apply(SetItemCountFunction.setCount(UniformGenerator.between(0.0F, 2.0F)))
						.apply(EnchantedCountIncreaseFunction.lootingMultiplier(this.registries, UniformGenerator.between(0.0F, 1.0F)))
		...
		add(TFEntities.LICH.get(),
			LootTable.lootTable()
				...
				.withPool(LootPool.lootPool()
					.setRolls(ConstantValue.exactly(1.0F))
					.add(LootItem.lootTableItem(TFItems.EXANIMATE_ESSENCE.get())
						.apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F)))
						.apply(EnchantedCountIncreaseFunction.lootingMultiplier(this.registries, UniformGenerator.between(0.0F, 1.0F)))
		...
		add(TFEntities.KNIGHT_PHANTOM.get(), LootTable.lootTable()
			.withPool(LootPool.lootPool()
				...
				.add(LootItem.lootTableItem(TFItems.KNIGHTMETAL_SWORD.get()).apply(EnchantWithLevelsFunction.enchantWithLevels(this.registries, ConstantValue.exactly(20))))
				.add(LootItem.lootTableItem(TFItems.KNIGHTMETAL_PICKAXE.get()).apply(EnchantWithLevelsFunction.enchantWithLevels(this.registries, ConstantValue.exactly(20))))
				.add(LootItem.lootTableItem(TFItems.KNIGHTMETAL_AXE.get()).apply(EnchantWithLevelsFunction.enchantWithLevels(this.registries, ConstantValue.exactly(20)))))
			.withPool(LootPool.lootPool()
				...
				.add(LootItem.lootTableItem(TFItems.PHANTOM_HELMET.get()).apply(EnchantWithLevelsFunction.enchantWithLevels(this.registries, ConstantValue.exactly(20))))
				.add(LootItem.lootTableItem(TFItems.PHANTOM_CHESTPLATE.get()).apply(EnchantWithLevelsFunction.enchantWithLevels(this.registries, ConstantValue.exactly(20)))))
			.withPool(LootPool.lootPool()
				...
				.add(LootItem.lootTableItem(TFItems.PHANTOM_HELMET.get()).apply(EnchantWithLevelsFunction.enchantWithLevels(this.registries, ConstantValue.exactly(30))))
				.add(LootItem.lootTableItem(TFItems.PHANTOM_CHESTPLATE.get()).apply(EnchantWithLevelsFunction.enchantWithLevels(this.registries, ConstantValue.exactly(30))))));
