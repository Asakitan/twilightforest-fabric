	...
	public void generate(HolderLookup.Provider registries, Consumer<AdvancementHolder> consumer) {
		...
		AdvancementHolder lamp = Advancement.Builder.advancement().parent(giants).display(
				...
				Component.translatable("advancement.twilightforest.progress_troll.desc",
					Component.translatable(TFItems.LAMPOFCINDERS.get().getDescriptionId())),
				null, AdvancementType.GOAL, true, true, false)
			.addCriterion("lamp", InventoryChangeTrigger.TriggerInstance.hasItems(TFItems.LAMPOFCINDERS.get()))
...
//				.save(consumer, "twilightforest:progress_castle");
		...
		Advancement.Builder.advancement().parent(lich).display(
				...
				null, AdvancementType.CHALLENGE, true, true, true)
			.addCriterion("drink_4_harming", DrinkFromFlaskTrigger.TriggerInstance.drankPotion(3, MinMaxBounds.Ints.atMost(6), Potions.STRONG_HARMING))
			.rewards(AdvancementRewards.Builder.experience(100))
	...
	private ItemStack e115Tag(String key) {
		...
		itemstack.set(TFDataComponents.E115_VARIANT, key);
		return itemstack;
	}
