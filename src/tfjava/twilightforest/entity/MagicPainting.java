...
/**
 * 1:1 port of upstream {@code twilightforest.entity.MagicPainting} —
 * {@link HangingEntity} subclass whose visual is a server-side
 * {@link MagicPaintingVariant} reference (datapack-registered, datapack supplies
 * Layer/Parallax/OpacityModifier composition that the paired client renders).
 *
